...
const AlzheimerModel2 = ({ isRotating, setIsRotating }) => {
  const modelRef = useRef();
  const { scene } = useGLTF('/models-3d/Alzheimer1.glb');
  ...
  // Teclado: flechas, R y barra espaciadora (escala)
...
export default AlzheimerModel2;
