...
const Register = () => {
  ...
  const handleLogin = useCallback(()=>{
   ...
   const options = [
    { value: '', text: '--Género--', disabled: true,className: 'desabled-option'},
      ...
      <div className="login-section">
        ...
        <div className="input-group">
          ...
          <div className="row-age-geder">
            ...
            >
              {options.map((option) => (
                <option key={option.value} value={option.value} className={option.className} disabled={option.disabled || false}>
                  {option.text}
                </option>
              ))}
            </select>
